    ...
    <div className="flex h-screen items-center justify-center bg-[#f8f7f4]">
      <div className="w-full max-w-md p-8 bg-white rounded-xl shadow-sm border border-neutral-200">
        ...
        <button
          ...
          disabled={loading}
          className="mt-6 w-full inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 border border-neutral-200 bg-white text-neutral-900 hover:bg-neutral-50 px-4 py-2 shadow-sm"
        >
