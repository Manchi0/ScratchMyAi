    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex w-1/2 p-12 flex-col justify-between text-white relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 relative z-10">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-[#1a1a1a] shadow-sm">
            <Blocks size={20} />
          </div>
          <span className="text-xl font-semibold tracking-tight">ScratchMyAi</span>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#faf9f5] p-6 lg:p-12">
        <div className="w-full max-w-[400px]">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#1a1a1a] text-white shadow-sm">
              <Blocks size={20} />
            </div>
            <span className="text-xl font-semibold tracking-tight text-[#111]">ScratchMyAi</span>
          </div>

          <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-[#e8e7e2]">
            <h2 className="text-2xl font-semibold text-center mb-8 text-[#111] tracking-tight">Welcome Back</h2>
