# Research Rodeo Design System

This document outlines the core styling conventions, variables, and components used in the **Research Rodeo** frontend. Future development must align with these specifications to maintain the intended aesthetic.
